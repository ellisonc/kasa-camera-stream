...
class FfmpegWrapper:
    def startProcess(self):
        ...
        for cam in self.controller.config["cams"]:
            startCommand = [
                'ffmpeg',
                '-nostdin',
                '-loglevel',
                ...
                'h264',
                '-i',
                f'https://{cam["cameraip"]}:19443/https/stream/mixed?video=h264&audio=g711&resolution=hd',
                '-map',
                '0',
                '-vcodec',
                'copy',
                ...
                '-f',
                'flv',
                f'rtmp://localhost/live/{cam["cameraname"]}',
                '-map',
                '0',
                '-r',
                '1/5',
